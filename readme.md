...
**Samples**
Here are some examples of titles generated by the model (see a large dump in [this file](https://github.com/csinva/gpt-paper-title-generator/tree/master/samples/gptneo/2021)):
